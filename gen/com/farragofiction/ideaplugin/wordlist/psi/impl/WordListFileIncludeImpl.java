...
public class WordListFileIncludeImpl extends ASTWrapperPsiElement implements WordListFileInclude {

  public WordListFileIncludeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WordListVisitor visitor) {
    visitor.visitFileInclude(this);
  }
