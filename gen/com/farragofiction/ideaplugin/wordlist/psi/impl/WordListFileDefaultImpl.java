...
public class WordListFileDefaultImpl extends ASTWrapperPsiElement implements WordListFileDefault {

  public WordListFileDefaultImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WordListVisitor visitor) {
    visitor.visitFileDefault(this);
  }
