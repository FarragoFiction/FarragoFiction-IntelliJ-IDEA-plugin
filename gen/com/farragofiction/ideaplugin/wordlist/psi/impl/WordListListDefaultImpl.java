...
public class WordListListDefaultImpl extends ASTWrapperPsiElement implements WordListListDefault {

  public WordListListDefaultImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WordListVisitor visitor) {
    visitor.visitListDefault(this);
  }
