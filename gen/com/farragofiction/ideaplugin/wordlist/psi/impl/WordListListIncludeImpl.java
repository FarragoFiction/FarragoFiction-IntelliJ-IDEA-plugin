...
public class WordListListIncludeImpl extends ASTWrapperPsiElement implements WordListListInclude {

  public WordListListIncludeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WordListVisitor visitor) {
    visitor.visitListInclude(this);
  }
